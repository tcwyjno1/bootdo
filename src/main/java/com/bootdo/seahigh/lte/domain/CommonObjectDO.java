package com.bootdo.seahigh.lte.domain;
 ...
 */
public class CommonObjectDO implements Serializable {
	...
	//对象定义ID
	private Integer objectDefineId;
	//对象名称
	 ...
	 * 设置：对象定义ID
	 */
	public void setObjectDefineId(Integer objectDefineId) {
		this.objectDefineId = objectDefineId;
	}
	/**
	 * 获取：对象定义ID
	 */
	public Integer getObjectDefineId() {
	 ...
	 * 设置：对象名称
	 */
	public void setObjectDistrict(String objectDistrict) {
