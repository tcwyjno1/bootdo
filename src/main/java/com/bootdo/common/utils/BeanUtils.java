    ...
    public static void copySimpleProperties(Object des, Object src) {
        ...
        for(int i = 0; i < origDescriptors.length; ++i) {
            ...
            if (!"class".equals(name)) {
                ...
                if ((clz.isEnum() || clz.getName().startsWith("java.lang") || clz.getName().startsWith("java.sql")) && getPropertyUtils().isReadable(src, name) && getPropertyUtils().isWriteable(des, name)) {
                    try {
